...
export declare const networks: {
    readonly futurenet: {
        ...
        readonly contractId: "CBAXERCQJFTHAE6X2VKURINWKQEK7OH3XPXH3PHOUPVKGYX2S57YFT7U";
    };
};
...
export declare class Contract {
    ...
    setAdmin<R extends ResponseTypes = undefined>({ old_admin, new_admin }: {
        old_admin: Address;
        new_admin: Address;
    }, options?: {
        /**
    ...
    }): Promise<R extends undefined ? ErrorCode : R extends "simulated" ? SorobanClient.SorobanRpc.SimulateTransactionResponse : R extends "full" ? SorobanClient.SorobanRpc.SimulateTransactionResponse | SorobanClient.SorobanRpc.SendTransactionResponse | SorobanClient.SorobanRpc.GetTransactionResponse : ErrorCode>;
    setFee<R extends ResponseTypes = undefined>({ admin, fee_rate, fee_wallet }: {
        admin: Address;
        fee_rate: u32;
        fee_wallet: Address;
    }, options?: {
    ...
    getFee<R extends ResponseTypes = undefined>(options?: {
         ...
         */
        secondsToWait?: number;
    }): Promise<R extends undefined ? readonly [number, SorobanClient.Address] : R extends "simulated" ? SorobanClient.SorobanRpc.SimulateTransactionResponse : R extends "full" ? SorobanClient.SorobanRpc.SimulateTransactionResponse | SorobanClient.SorobanRpc.SendTransactionResponse | SorobanClient.SorobanRpc.GetTransactionResponse : readonly [number, SorobanClient.Address]>;
    getLastError<R extends ResponseTypes = undefined>(options?: {
        /**
         * The fee to pay for the transaction. Default: 100.
         */
        fee?: number;
    ...
    resetLastError<R extends ResponseTypes = undefined>(options?: {
        /**
         * The fee to pay for the transaction. Default: 100.
         */
        fee?: number;
    ...
    countBounties<R extends ResponseTypes = undefined>(options?: {
        /**
         * The fee to pay for the transaction. Default: 100.
         */
        fee?: number;
    ...
    countWorks<R extends ResponseTypes = undefined>(options?: {
        /**
         * The fee to pay for the transaction. Default: 100.
         */
        fee?: number;
    ...
    createBounty<R extends ResponseTypes = undefined>({ creator, name, reward, pay_token, deadline, expiration_ledger }: {
        creator: Address;
        name: string;
        reward: u64;
        pay_token: Address;
    ...
    submitWork<R extends ResponseTypes = undefined>({ participant, work_id, work_repo }: {
        participant: Address;
        work_id: u32;
        work_repo: string;
    }, options?: {
